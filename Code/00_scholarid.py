...
df_member.merge(pd.read_excel(r"./DataProcessed/CIDA's Members.xlsx"), how='left', on=['Last Name', 'First Name']).to_excel("./DataProcessed/PERSONEL ROSTER for CIDA and B&I-NEC.xlsx",index=False)